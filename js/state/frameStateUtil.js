 ...
 * This method should be used wherever the hoverState
...
/**
 * Gets the tab index state
 * This method is a state wrapper and should
 * only used internally by getTabHoverState
 * @param state {Object} - Application state
